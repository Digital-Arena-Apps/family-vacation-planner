...
const GROUPS = {
  pace: {
    ...
    options: [
      ['relaxed', 'Easy-going', 'Fewer stops, more breathing room and time to linger.', '☕'],
      ['balanced', 'Balanced', 'A good amount planned without turning the day into a race.', '◐'],
      ['full', 'Pack it in', 'We are happy with fuller days when there is plenty worth doing.', '⚡']
    ]
  },
  budget: {
  ...
  rhythm: {
    ...
    options: [
      ['early', 'Early starters', 'Happy to get moving early and make use of quieter mornings.', '☀'],
      ['flexible', 'Flexible', 'No strong preference — adapt to the day.', '↔'],
      ['late', 'Later starters', 'Avoid plans that rely on everyone being out at dawn.', '☾']
    ]
  },
  discovery: {
    ...
    options: [
      ['familiar', 'Familiar favourites', 'Lean toward proven, predictable options.', '✓'],
      ['mix', 'Mix it up', 'Blend reliable choices with a few interesting discoveries.', '✦'],
      ['discover', 'Surprise us', 'Give unusual and local discoveries a real chance to rank.', '◎']
    ]
  },
  walking: {
    ...
    options: [
      ['low', 'Keep walking lower', 'Prefer compact plans and avoid needless backtracking.', '◌'],
      ['normal', 'Normal holiday walking', 'Some distance is fine if the day still flows well.', '→'],
      ['high', 'Happy to walk lots', 'Distance is less important than getting to the best option.', '↗']
    ]
  }
};
